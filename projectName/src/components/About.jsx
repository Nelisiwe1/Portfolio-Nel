...
function About() {
  ...
  <div class="flex flex-col md:flex-row items-center justify-center md:gap-10">
    <div class="md:flex-1 md:order-2">
      <div class="text-center md:text-left">
        <div>
          <h1 class="text-3xl lg:text-5xl lg-heading mb-4">
            About <span class="text-secondary">Me</span>
          </h1>
        </div>
        <div class="w-3/4 md:w-1/2 lg:w-2/3 xl:w-1/2">
    ...
    <div class="flex justify-end md:mb-4 md:mr-8 md:order-1">
    <img src="IMG-20231229-WA0033.jpg" class="w-64 h-auto object-cover md:mr-4" alt="Neliswe Ngqeme" />
